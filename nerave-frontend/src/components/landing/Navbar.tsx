...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full mb-6 z-50 px-6 lg:px-12 py-5 bg-white/5 backdrop-blur-xl overflow-x-hidden border-b border-white/10">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex items-center gap-2">
          {/* Flat logo text */}
          <span className="text-xl text-black font-medium tracking-tight">
            Nerave
          </span>
        </div>
        ...
        {open && (
          ...
          >
            <div className="flex flex-col p-4 gap-2">
              <a
                href="#docs"
                className="p-3 text-white/70 hover:text-white hover:bg-white/5 rounded-lg"
