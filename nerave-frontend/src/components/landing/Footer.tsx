    ...
    <footer className="px-6 lg:px-12 py-12 border-t border-gray-200 bg-white relative z-20">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
          <div>
            <span className="text-xl font-medium tracking-tight text-gray-900">Nerave</span>
            <p className="text-sm text-gray-500 mt-2">The trustless escrow platform for African B2B.</p>
          </div>
